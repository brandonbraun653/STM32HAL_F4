...
namespace STM32HAL_Mock 
{
  ...
  using UARTNiceMock = ::testing::NiceMock<UARTMock>;
  using UARTNiceMock_sPtr = std::shared_ptr<UARTNiceMock>;
  
	extern UARTNiceMock_sPtr uartMockObj;
}
